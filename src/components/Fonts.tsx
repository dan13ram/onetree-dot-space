  ...
  <Global
    styles={`
      @font-face {
        ...
        font-weight: 400 700;
        font-display: swap;
        src: url("https://raw.githubusercontent.com/dconstruct/Bagnard/master/BagnardSans.otf") format("opentype");
      }
      ...
      @font-face {
        ...
        font-weight: 400 700;
        font-display: swap;
        src: url("https://raw.githubusercontent.com/dconstruct/Bagnard/master/Bagnard.otf") format("opentype");
      }
